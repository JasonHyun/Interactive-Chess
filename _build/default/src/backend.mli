...
(* val demo : board_coord -> board_coord -> board -> piece_type ->
   bool *)
...
(* val get_time_left: player -> time (*Returns the amount of time that
   the given player has remaining*) val get_legal_moves: coordinate ->
   coordinate list *)
